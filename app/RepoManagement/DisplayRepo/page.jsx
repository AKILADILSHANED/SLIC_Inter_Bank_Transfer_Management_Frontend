        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 uppercase tracking-wider whitespace-nowrap">
                  REPO ID
                </th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 uppercase tracking-wider whitespace-nowrap">
                  Account
                ...
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-9000 uppercase tracking-wider whitespace-nowrap">
                  Interest Rate (%)
                </th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 uppercase tracking-wider whitespace-nowrap">
                  REPO Type
