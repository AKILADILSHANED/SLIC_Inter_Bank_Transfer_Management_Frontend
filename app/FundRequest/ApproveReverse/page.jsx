    ...
    <div>
      <div className="bg-red-800 h-[30px] flex flex-row items-center mt-4">
        <label className="text-white ml-3 text-lg font-serif">
          List of Fund Request for reversal of approvals
        </label>
      </div>
              ...
              {requestDetails.map((element) => (
                <tr
                  ...
                  <td className="px-6 py-4">
                    <button
                      type="submit"
                      onClick={() => handleApprove(element.requestId)}
                      className="bg-red-600 shadow-sm shadow-slate-800 flex flex-row items-center justify-center text-white h-[28px] w-[90px] rounded-md hover:bg-red-700">
                      {approveSpinner === element.requestId && (
                        <Spinner size={20} />
                      )}
                      <label className="ml-1">Reverse</label>
                    </button>
                  </td>
                </tr>
              ))}
