...
export default function DashBoard() {
  ...
  return (
    <div>
      <div className="bg-blue-900 hover:bg-blue-800 shadow-md mt-1 h-[45px] w-full hover: text-white flex flex-row items-center">
        <div className="ml-4">
          <svg
      ...
      <div className="ml-[280px] mt-[-574px] w-[calc(100vw-280px)] h-[calc(100vh-45px)] shadow-md w-screen min-h-screen">
