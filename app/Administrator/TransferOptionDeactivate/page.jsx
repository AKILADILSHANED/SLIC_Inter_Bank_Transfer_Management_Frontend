...
export default function TransferOptionDeactivate() {
    ...
    const handleOptionDeactivate = async (optionId) => {
        try {
                    ...
                    <tbody>
                        {transferOptions.map((element) => (
                            <tr
                                ...
                                <td>
                                    <button onClick={() => handleOptionDeactivate(element.optionId)} type="button" className="flex gap-1 items-center justify-center w-[110px] h-[30px] text-white bg-red-600 hover:bg-red-800 font-medium rounded-md text-md dark:bg-red-600 dark:hover:bg-red-700">{deactivateSpinner && <Spinner size={20} />}<label>De-activate</label></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
